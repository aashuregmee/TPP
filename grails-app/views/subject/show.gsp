	...
	<body>
		...
		<div id="show-subject" class="content scaffold-show" role="main">
			...
			<ol class="property-list subject">
				...
				<g:if test="${subjectInstance?.semesterNo}">
				<li class="fieldcontain">
					<span id="semesterNo-label" class="property-label"><g:message code="subject.semesterNo.label" default="Semester No" /></span>
					
						<span class="property-value" aria-labelledby="semesterNo-label"><g:fieldValue bean="${subjectInstance}" field="semesterNo"/></span>
