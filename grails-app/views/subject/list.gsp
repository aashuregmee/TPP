			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="semesterNo" title="${message(code: 'subject.semesterNo.label', default: 'Semester No')}" />
				...
				<g:each in="${subjectInstanceList}" status="i" var="subjectInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: subjectInstance, field: "semesterNo")}</td>
